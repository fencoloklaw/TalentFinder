...
/* harmony import */ var _components_my_job_posts_my_job_posts_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./components/my-job-posts/my-job-posts.component */ "./src/app/components/my-job-posts/my-job-posts.component.ts");
...
var appRoutes = [
    ...
    { path: 'my-job-posts', component: _components_my_job_posts_my_job_posts_component__WEBPACK_IMPORTED_MODULE_29__["MyJobPostsComponent"] },
];
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _components_my_job_posts_my_job_posts_component__WEBPACK_IMPORTED_MODULE_29__["MyJobPostsComponent"],
                ng2_file_upload__WEBPACK_IMPORTED_MODULE_30__["FileSelectDirective"]
            ],
            imports: [
...
var CompanyProfileComponent = /** @class */ (function () {
    ...
    CompanyProfileComponent.prototype.onUpdateProfile = function () {
    };
...
/***/ "./src/app/components/my-job-posts/my-job-posts.component.css":
/*!********************************************************************!*\
  !*** ./src/app/components/my-job-posts/my-job-posts.component.css ***!
  \********************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/my-job-posts/my-job-posts.component.html":
/*!*********************************************************************!*\
  !*** ./src/app/components/my-job-posts/my-job-posts.component.html ***!
  \*********************************************************************/
/*! no static exports found */
...
/***/ "./src/app/components/my-job-posts/my-job-posts.component.ts":
/*!*******************************************************************!*\
  !*** ./src/app/components/my-job-posts/my-job-posts.component.ts ***!
  \*******************************************************************/
/*! exports provided: MyJobPostsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MyJobPostsComponent", function() { return MyJobPostsComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var MyJobPostsComponent = /** @class */ (function () {
    function MyJobPostsComponent() {
    }
    MyJobPostsComponent.prototype.ngOnInit = function () {
    };
    MyJobPostsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-my-job-posts',
            template: __webpack_require__(/*! ./my-job-posts.component.html */ "./src/app/components/my-job-posts/my-job-posts.component.html"),
            styles: [__webpack_require__(/*! ./my-job-posts.component.css */ "./src/app/components/my-job-posts/my-job-posts.component.css")]
        }),
        __metadata("design:paramtypes", [])
    ], MyJobPostsComponent);
...
var PostjobComponent = /** @class */ (function () {
    function PostjobComponent(validateService, toasterService, router, authService) {
        this.validateService = validateService;
        this.toasterService = toasterService;
        this.router = router;
        this.authService = authService;
    ...
    PostjobComponent.prototype.onPostJobClick = function () {
        var _this = this;
        var jobPost = {
        ...
        //Register User
        this.authService.createJobPost(jobPost).subscribe(function (data) {
            if (data.err) {
                _this.router.navigate(['/postjob']).then(function () {
                    _this.toasterService.error('Something went wrong: ' + data.err);
                });
            }
            _this.router.navigate(['/my-job-posts']).then(function () {
                _this.toasterService.success('Job has been Posted!');
            });
        });
    };
...
module.exports = "<div class=\"container-fluid\" style=\"margin-top:100px;\">\r\n    <form (submit)=\"onUpdateProfile()\">\r\n        <h2 class=\"page-header\">\r\n            <span>Profile</span>\r\n        </h2>\r\n        <div class=\"row mb-3\">\r\n            <div class=\"col-3\">\r\n                <form enctype=\"multipart/form-data\" (submit)=\"onUpdatePicture()\">\r\n                    <img class=\"img-thumbnail\" [src]=\"avatar\" alt=\"Profile Picture\">\r\n                    <input type=\"file\" (change)=\"onFileChanged($event)\" #fileInput>\r\n                    <button type=\"submit\">Upload!</button>\r\n                    <!--<input class=\"btn\" type=\"submit\" id=\"imgSubmit\" value=\"Value\">-->\r\n                </form>\r\n                <!--<img class=\"img-thumbnail\" src=\"http://i0.kym-cdn.com/photos/images/newsfeed/000/581/296/c09.jpg\">-->\r\n            </div>\r\n            <div class=\"col-6\">\r\n                <div class=\"row mb-3\">\r\n                    <div class=\"col\">\r\n                        <input type=\"text\" [(ngModel)]=\"lastName\" name=\"lastName\" class=\"form-control\" placeholder=\"Last Name\">\r\n                    </div>\r\n                    <div class=\"col\">\r\n                        <input type=\"text\" [(ngModel)]=\"firstName\" name=\"firstName\" class=\"form-control\" placeholder=\"First Name\">\r\n                    </div>\r\n                </div>\r\n                <div class=\"row mb-3\">\r\n                    <div class=\"col\">\r\n                        <input type=\"text\" [(ngModel)]=\"city\" name=\"city\" class=\"form-control\" placeholder=\"City\">\r\n                    </div>\r\n                    <div class=\"col\">\r\n                        <label>Province/State :</label>\r\n                        <select [(ngModel)]=\"region\" name=\"region\" class=\"form-control custom-select required\">\r\n                            <option value=\"Alberta\">Alberta</option>\r\n                            <option value=\"British Columbia\">British Columbia</option>\r\n                            <option value=\"Manitoba\">Manitoba</option>\r\n                            <option value=\"New Brunswick\">New Brunswick</option>\r\n                            <option value=\"Newfoundland and Labrador\">Newfoundland and Labrador</option>\r\n                            <option value=\"Nova Scotia\">Nova Scotia</option>\r\n                            <option value=\"Ontario\">Ontario</option>\r\n                            <option value=\"Prince Edward Island\">Prince Edward Island</option>\r\n                            <option value=\"Quebec\">Quebec</option>\r\n                            <option value=\"Saskatchewan\">Saskatchewan</option>\r\n                            <option value=\"Northwest Territories\">Northwest Territories</option>\r\n                            <option value=\"Nunavut\">Nunavut</option>\r\n                            <option value=\"Yukon\">Yukon</option>\r\n                        </select>\r\n                    </div>\r\n                </div>\r\n            </div>\r\n            <div class=\"col-3\">\r\n                <img class=\"img-thumbnail float-right\" src=\"https://www.patternfly.org/pattern-library/data-visualization/pie-chart/img/right-legend-pie-chart.png\">\r\n            </div>\r\n        </div>\r\n        <div class=\"container\">\r\n            <div class=\"row mb-3\">\r\n                <div class=\"col\">\r\n                    <label><u>Skills</u></label>\r\n                    <input type=\"text\" [(ngModel)]=\"skill\" name=\"skill\" class=\"form-control\">\r\n                </div>\r\n            </div>\r\n            <div class=\"row mb-3\">\r\n                <div class=\"col\">\r\n                    <label><u>Summary</u></label>\r\n                    <textarea class=\"form-control\" rows=\"4\" name=\"description\" [(ngModel)]=\"description\" placeholder=\"Introduction/Description\"></textarea>\r\n                </div>\r\n            </div>\r\n            <div class=\"row mb-3\">\r\n                <div class=\"col\">\r\n                    <label><u>Work History</u></label>\r\n                    <textarea class=\"form-control\" rows=\"4\" placeholder=\"Past Experience\" name=\"experience\" [(ngModel)]=\"experience\"></textarea>\r\n                </div>\r\n            </div>\r\n            <div class=\"row mb-3\">\r\n                <div class=\"col\">\r\n                    <label><u>Certificates/Licenses</u></label>\r\n                    <input type=\"text\" [(ngModel)]=\"certificates\" name=\"certificates\" class=\"form-control\">\r\n                </div>\r\n                <div class=\"col\">\r\n                    <label><u>Awards</u></label>\r\n                    <input type=\"text\" [(ngModel)]=\"awards\" name=\"awards\" class=\"form-control\">\r\n                </div>\r\n            </div>\r\n            <div class=\"row mb-3\">\r\n                <div class=\"col\">\r\n                    <label><u>Tests</u></label>\r\n                </div>\r\n            </div>\r\n            <div class=\"text-center\">\r\n                <input type=\"submit\" class=\"btn btn-block btn-primary\" value=\"Update\">\r\n            </div>\r\n        </div>\r\n    </form>\r\n</div>"
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(authService, router, toasterService) {
        ...
        this.router = router;
        this.toasterService = toasterService;
        this.avatar = "uploads/profile_image.png";
        this.URL = '';
        this.uploader = new ng2_file_upload__WEBPACK_IMPORTED_MODULE_4__["FileUploader"]({ url: this.URL, itemAlias: 'photo' });
    }
    ProfileComponent.prototype.ngOnInit = function () {
        ...
        this.authService.getProfile().subscribe(function (profile) {
            ...
            if (profile.user.avatar.length > 0) {
                _this.avatar = "uploads/" + profile.user.avatar;
            }
    ...
    ProfileComponent.prototype.onUpdatePicture = function () {
        var _this = this;
        var uploadData = new FormData();
        uploadData.append('myFile', this.selectedFile, this._id.toString());
        this.authService.uploadPicture(uploadData).subscribe(function (data) {
            if (data.err) {
                _this.toasterService.error('Error');
            }
            else {
                _this.avatar = "uploads/" + data.filename;
                _this.toasterService.success('Updated Profile Picture');
            }
        });
    };
...
var SearchjobsComponent = /** @class */ (function () {
    ...
    SearchjobsComponent.prototype.onSearchSubmit = function () {
        ...
        if (this.validateService.validateNotNull(this.whereInput)) {
            this.searchService.searchJobPost(search).subscribe(function (data) {
                if (data.success) {
    ...
    SearchjobsComponent.prototype.showJobPost = function (data) {
...
var SearchtalentComponent = /** @class */ (function () {
    ...
    SearchtalentComponent.prototype.changeSearch = function (skill) {
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.uploadPicture = function (image) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverUrl + '/users/upload', image);
    };
    ...
    AuthService.prototype.createJobPost = function (jobPost) {
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverUrl + '/users/postjob', jobPost);
    };
    ...
    AuthService.prototype.getProfilePicture = function (avatar) {
        this.loadToken();
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]().set('Authorization', this.tokenGetter());
        return this.http.put(_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverUrl + '/users/profilePicture', avatar, { headers: headers });
    };
...
var SearchService = /** @class */ (function () {
    ...
    SearchService.prototype.searchJobPost = function (search) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].serverUrl + '/users/searchJobs', search, { headers: headers });
    };
    SearchService.prototype.getRelatedSkills = function (search) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]({ 'Content-Type': 'application/json' });
        return this.http.post(_environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].serverUrl + '/users/recommendations', search, { headers: headers });
    };
...
var ValidateService = /** @class */ (function () {
    ...
    ValidateService.prototype.validateJobPost = function (jobPost) {
