...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_13__services_validate_service__["a" /* ValidateService */], __WEBPACK_IMPORTED_MODULE_15__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_16__guards_auth_guard__["a" /* AuthGuard */], __WEBPACK_IMPORTED_MODULE_17__services_search_service__["a" /* SearchService */]],
...
module.exports = "<div class=\"jumbotron text-center\">\r\n    <table role=\"Search\" width=\"700\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\" align=\"center\" style=\"margin-top:1em\">\r\n        <tbody>\r\n        <tr>\r\n            <h1> Freelancer </h1>\r\n        </tr>\r\n        <tr>\r\n            <form (submit)=\"onSearchSubmit()\">\r\n                <table cellspacing=\"0\" cellpadding=\"3\" width=\"100%\" allign=\"center\">\r\n                    <tr>\r\n                        <td class=\"hp sl\">\r\n                            <label for=\"skill\" id=\"hpskill_label\" aria-hidden=\"true\">Skill</label>\r\n                        </td>\r\n                        <td class=\"hp wl\" colspan=\"2\">\r\n                            <label for=\"where\" id=\"hpwhere_label\" aria-hidden=\"true\">Where</label>\r\n                        </td>\r\n                    </tr>\r\n                    <tr>\r\n                        <td class=\"hp sit\">\r\n        <span class=\"inwrap\">\r\n          <input type=\"text\"\r\n                 [(ngModel)]=\"hpSkillInputBox\"\r\n                 maxlength=\"512\"\r\n                 size=\"31\"\r\n                 aria-labelledby=\"skill_label_top hidden_colon skill_label_bot\"\r\n                 name=\"hpSkillInputBox\"\r\n                 autocomplete=\"on\"\r\n                 id=\"hpskill_box\">\r\n        </span>\r\n                        </td>\r\n                        <td class=\"hp wit\">\r\n        <span class=\"inwrap\">\r\n          <input type=\"text\"\r\n                 [(ngModel)]=\"hpWhereInputBox\"\r\n                 maxlength=\"64\"\r\n                 size=\"31\"\r\n                 aria-labelledby=\"where_label_top hidden_colon where_label_bot\"\r\n                 name=\"hpWhereInputBox\"\r\n                 autocomplete=\"on\"\r\n                 id=\"hpwhere_box\">\r\n        </span>\r\n                        </td>\r\n                        <td class=\"hpinput_submit\" style=width:1px>\r\n        <span class=\"inwrapBorder style=width:auto;\">\r\n          <input id=\"hpfind_talent\" type=\"submit\" class=\"input_submit\" value=\"Find Talents\">\r\n        </span>\r\n                        </td>\r\n                    </tr>\r\n                </table>\r\n            </form>\r\n        </tr>\r\n        </tbody>\r\n    </table>"
...
var HomeComponent = (function () {
    function HomeComponent(router, flashMessage, validateService, authService) {
        this.router = router;
...
module.exports = "<form (submit)=\"onSearchSubmit()\">\r\n    <table cellspacing=\"0\" cellpadding=\"3\" width=\"100%\" allign=\"center\">\r\n        <tr>\r\n            <td class=\"hp sl\">\r\n                <label for=\"skill\" id=\"hpskill_label\" aria-hidden=\"true\">skill</label>\r\n            </td>\r\n            <td class=\"hp wl\" colspan=\"2\">\r\n                <label for=\"where\" id=\"hpwhere_label\" aria-hidden=\"true\">where</label>\r\n            </td>\r\n        </tr>\r\n        <tr>\r\n            <td class=\"hp sit\">\r\n        <span class=\"inwrap\">\r\n          <input type=\"text\"\r\n                 [(ngModel)]=\"hpSkillInputBox\"\r\n                 maxlength=\"512\"\r\n                 size=\"31\"\r\n                 aria-labelledby=\"skill_label_top hidden_colon skill_label_bot\"\r\n                 name=\"hpSkillInputBox\"\r\n                 autocomplete=\"off\"\r\n                 id=\"hpskill_box\">\r\n        </span>\r\n            </td>\r\n            <td class=\"hp wit\">\r\n        <span class=\"inwrap\">\r\n          <input type=\"text\"\r\n                 [(ngModel)]=\"hpWhereInputBox\"\r\n                 maxlength=\"64\"\r\n                 size=\"31\"\r\n                 aria-labelledby=\"where_label_top hidden_colon where_label_bot\"\r\n                 name=\"hpWhereInputBox\"\r\n                 autocomplete=\"off\"\r\n                 id=\"hpwhere_box\">\r\n        </span>\r\n            </td>\r\n            <td class=\"hpinput_submit\" style=width:1px>\r\n                <span class=\"inwrapBorder style=width:auto;\">\r\n                  <input id=\"hpfind_talent\" type=\"submit\" class=\"input_submit\" value=\"Find Talents\">\r\n                </span>\r\n            </td>\r\n        </tr>\r\n    </table>\r\n</form>\r\n\r\n<form>\r\n    <div *ngIf=\"user\">\r\n        <h2 class=\"page-header\">{{user.name}}</h2>\r\n        <ul class=\"list-group\">\r\n            <li class=\"list-group-item\">Username: {{user.username}}</li>\r\n            <li class=\"list-group-item\">Email: {{user.email}}</li>\r\n            <li class=\"list-group-item\">Skills: {{user.skill}}</li>\r\n            <li class=\"list-group-item\">Experience: {{user.experience}}</li>\r\n            <li class=\"list-group-item\">Volunteer: {{user.volunteer}}</li>\r\n        </ul>\r\n    </div>\r\n</form>"
...
var SearchtalentComponent = (function () {
    function SearchtalentComponent(router, flashMessage, validateService, authService, searchService) {
        this.router = router;
        this.flashMessage = flashMessage;
        this.validateService = validateService;
        this.authService = authService;
    ...
    SearchtalentComponent.prototype.onSearchSubmit = function () {
        ...
        if (this.validateService.validateWhere(search)) {
            ...
            this.searchService.searchUser(search).subscribe(function (user) {
                if (user.success) {
...
var ValidateService = (function () {
    ...
    ValidateService.prototype.validateWhere = function (searchFunction) {
