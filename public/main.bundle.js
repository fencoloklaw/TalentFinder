        ...
        if (this.validateService.validateNotNull(this.hpWhereInputBox)) {
            ...
            this.searchService.searchUser(search).subscribe(function (data) {
                if (data.success) {
                    ...
                    // document.write("<br/>");
                    var docArraySize = docArray.length;
                    // document.write(docArraySize);
                    for (var i = 0; i < docArraySize; i++) {
                        //load 10
