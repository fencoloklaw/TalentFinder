...
function waitForMap(obj, fn) {
    ...
    forEach(obj, function (a, k) {
        var /** @type {?} */ mapped = map.call(fn(k, a), function (r) {
            return res[k] = r;
        });
        if (k === PRIMARY_OUTLET) {
...
var ApplyRedirects = (function () {
    ...
    ApplyRedirects.prototype.expandRegularSegmentAgainstRouteUsingRedirect = function (ngModule, segmentGroup, routes, route, segments, outlet) {
        var _this = this;
        var _a = match(segmentGroup, route, segments), matched = _a.matched, consumedSegments = _a.consumedSegments,
            lastChild = _a.lastChild, positionalParamSegments = _a.positionalParamSegments;
        if (!matched)
            return noMatch(segmentGroup);
    ...
    ApplyRedirects.prototype.matchSegmentAgainstRoute = function (ngModule, rawSegmentGroup, route, segments) {
        ...
        var _a = match(rawSegmentGroup, route, segments), matched = _a.matched, consumedSegments = _a.consumedSegments,
        ...
        return mergeMap.call(childConfig$, function (routerConfig) {
            ...
            var _a = split(rawSegmentGroup, consumedSegments, rawSlicedSegments, childConfig),
                segmentGroup = _a.segmentGroup, slicedSegments = _a.slicedSegments;
            if (slicedSegments.length === 0 && segmentGroup.hasChildren()) {
                var /** @type {?} */ expanded$_1 = _this.expandChildren(childModule, childConfig, segmentGroup);
                return map.call(expanded$_1, function (children) {
...
var ActivatedRoute = (function () {
    ...
    Object.defineProperty(ActivatedRoute.prototype, "queryParamMap", {
        ...
        get: function () {
            if (!this._queryParamMap) {
                this._queryParamMap =
                    map.call(this.queryParams, function (p) {
                        return convertToParamMap(p);
                    });
            }
            return this._queryParamMap;
...
var Recognizer = (function () {
    ...
    Recognizer.prototype.processSegmentAgainstRoute = function (route, rawSegment, segments, outlet) {
        ...
        var _a = match$1(rawSegment, route, segments), consumedSegments = _a.consumedSegments,
            parameters = _a.parameters, lastChild = _a.lastChild;
        var /** @type {?} */ rawSlicedSegments = segments.slice(lastChild);
        var /** @type {?} */ childConfig = getChildConfig(route);
        var _b = split$1(rawSegment, consumedSegments, rawSlicedSegments, childConfig), segmentGroup = _b.segmentGroup,
...
var Router = (function () {
    ...
    Router.prototype.createUrlTree = function (commands, _a) {
        var _b = _a === void 0 ? {} : _a, relativeTo = _b.relativeTo, queryParams = _b.queryParams,
            fragment = _b.fragment, preserveQueryParams = _b.preserveQueryParams,
            queryParamsHandling = _b.queryParamsHandling, preserveFragment = _b.preserveFragment;
    ...
    Router.prototype.runNavigate = function (url, rawUrl, shouldPreventPushState, shouldReplaceUrl, id, precreatedState) {
        ...
        return new Promise(function (resolvePromise, rejectPromise) {
            ...
            var /** @type {?} */ beforePreactivationDone$ = mergeMap.call(urlAndSnapshot$, function (p) {
                return map.call(_this.hooks.beforePreactivation(p.snapshot), function () {
                    return p;
                });
            });
            ...
            var /** @type {?} */ preactivationDone$ = mergeMap.call(preactivationResolveData$, function (p) {
                return map.call(_this.hooks.afterPreactivation(p.snapshot), function () {
                    return p;
                });
            });
            // create router state
...
var PreActivation = (function () {
    ...
    PreActivation.prototype.traverseChildRoutes = function (futureNode, currNode, outletMap, futurePath) {
        ...
        forEach(prevChildren, function (v, k) {
            return _this.deactiveRouteAndItsChildren(v, /** @type {?} */ ((outletMap))._outlets[k]);
        });
    };
    /**
     * @param {?} futureNode
    ...
    PreActivation.prototype.runCanDeactivateChecks = function () {
        ...
        var /** @type {?} */ runningChecks$ = mergeMap.call(checks$, function (check) {
    ...
    PreActivation.prototype.runCanActivateChecks = function () {
        ...
        var /** @type {?} */ checks$ = from(this.canActivateChecks);
        var /** @type {?} */ runningChecks$ = mergeMap.call(checks$, function (check) {
            return andObservables(from([_this.runCanActivateChild(check.path), _this.runCanActivate(check.route)]));
        });
        return every.call(runningChecks$, function (result) {
            return result === true;
        });
...
export {
    ...
    flatten as ɵflatten,
    ROUTER_FORROOT_GUARD as ɵa,
    RouterInitializer as ɵg,
    getAppInitializer as ɵh,
    getBootstrapListener as ɵi,
    provideForRootGuard as ɵd,
    provideLocationStrategy as ɵc,
    provideRouterInitializer as ɵj,
    rootRoute as ɵf,
    routerNgProbeToken as ɵb,
    setupRouter as ɵe,
    Tree as ɵk,
    TreeNode as ɵl
};
