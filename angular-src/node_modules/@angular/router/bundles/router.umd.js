 ...
 */(function (global, factory) {
    ...
    function waitForMap(obj, fn) {
        ...
        forEach(obj, function (a, k) {
            var /** @type {?} */ mapped = rxjs_operator_map.map.call(fn(k, a), function (r) {
                return res[k] = r;
            });
            if (k === PRIMARY_OUTLET) {
 ...
 * }
    ...
    var ApplyRedirects = (function () {
        ...
        ApplyRedirects.prototype.expandSegment = function (ngModule, segmentGroup, routes, segments, outlet, allowRedirects) {
            ...
            var /** @type {?} */ first$ = rxjs_operator_first.first.call(concattedProcessedRoutes$, function (s) {
                return !!s;
            });
        ...
        ApplyRedirects.prototype.matchSegmentAgainstRoute = function (ngModule, rawSegmentGroup, route, segments) {
            ...
            var _a = match(rawSegmentGroup, route, segments), matched = _a.matched,
                consumedSegments = _a.consumedSegments, lastChild = _a.lastChild;
            if (!matched)
    ...
    var ActivatedRoute = (function () {
        ...
        Object.defineProperty(ActivatedRoute.prototype, "queryParamMap", {
            ...
            get: function () {
                if (!this._queryParamMap) {
                    this._queryParamMap =
                        rxjs_operator_map.map.call(this.queryParams, function (p) {
                            return convertToParamMap(p);
                        });
                }
                return this._queryParamMap;
 ...
 * }
    ...
    var Recognizer = (function () {
        ...
        Recognizer.prototype.processSegmentAgainstRoute = function (route, rawSegment, segments, outlet) {
            ...
            var _b = split$1(rawSegment, consumedSegments, rawSlicedSegments, childConfig),
                segmentGroup = _b.segmentGroup, slicedSegments = _b.slicedSegments;
    ...
    var PreActivation = (function () {
        ...
        PreActivation.prototype.runCanDeactivateChecks = function () {
            ...
            var /** @type {?} */ runningChecks$ = rxjs_operator_mergeMap.mergeMap.call(checks$, function (check) {
 ...
 * true}">Bob</a>
    ...
    var RouterPreloader = (function () {
        ...
        RouterPreloader.prototype.setUpPreloading = function () {
            var _this = this;
            var /** @type {?} */ navigations$ = rxjs_operator_filter.filter.call(this.router.events, function (e) {
