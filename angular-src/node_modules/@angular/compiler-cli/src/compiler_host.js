    ...
    CompilerHost.prototype.readMetadata = function (filePath, dtsFilePath) {
        ...
        try {
            ...
            var metadatas_1 = metadataOrMetadatas ?
                ...
                [];
            var v1Metadata = metadatas_1.find(function (m) {
                return m.version === 1;
            });
            var v3Metadata = metadatas_1.find(function (m) {
                return m.version === 3;
            });
...
var CompilerHostContextAdapter = (function () {
    ...
    CompilerHostContextAdapter.prototype.assumeFileExists = function (fileName) {
...
var ModuleResolutionHostAdapter = (function (_super) {
    ...
    function ModuleResolutionHostAdapter(host) {
        ...
        if (host.directoryExists) {
            _this.directoryExists = function (directoryName) {
    ...
    ModuleResolutionHostAdapter.prototype.readFile = function (fileName) {
...
var NodeCompilerHostContext = (function (_super) {
    ...
    NodeCompilerHostContext.prototype.readFile = function (fileName) {
