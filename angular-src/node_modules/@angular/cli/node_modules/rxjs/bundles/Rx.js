...
// typeof any so that it we don't have to cast when comparing a result to the error object
    ...
    var IteratorObservable = (function (_super) {
        ...
        IteratorObservable.dispatch = function (state) {
            var index = state.index, hasError = state.hasError, iterator$$1 = state.iterator,
 ...
 *   })
    ...
    function dispatch$1(state) {
        var obj = state.obj, keys = state.keys, length = state.length, index = state.index,
            subscriber = state.subscriber;
        if (index === length) {
            subscriber.complete();
            return;
    ...
    var AjaxSubscriber = (function (_super) {
        ...
        AjaxSubscriber.prototype.setupEvents = function (xhr, request) {
            ...
            function xhrReadyStateChange(e) {
                var _a = xhrReadyStateChange, subscriber = _a.subscriber, progressSubscriber = _a.progressSubscriber,
                    request = _a.request;
 ...
 * });
    ...
    var RepeatWhenSubscriber = (function (_super) {
        ...
        RepeatWhenSubscriber.prototype._unsubscribeAndRecycle = function () {
            var _a = this, notifications = _a.notifications, retries = _a.retries,
    ...
    var ThrottleSubscriber = (function (_super) {
        ...
        ThrottleSubscriber.prototype._unsubscribe = function () {
            var _a = this, throttled = _a.throttled, _trailingValue = _a._trailingValue,
                _hasTrailingValue = _a._hasTrailingValue, _trailing = _a._trailing;
        ...
        ThrottleSubscriber.prototype._sendTrailing = function () {
            var _a = this, destination = _a.destination, throttled = _a.throttled, _trailing = _a._trailing,
                _trailingValue = _a._trailingValue, _hasTrailingValue = _a._hasTrailingValue;
