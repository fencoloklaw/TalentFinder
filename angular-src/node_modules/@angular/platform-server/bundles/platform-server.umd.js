...
(function (global, factory) {
...
}(this, (function (exports, _angular_core, _angular_platformBrowser, _angular_animations_browser, _angular_common, _angular_compiler, _angular_http, _angular_platformBrowser_animations, rxjs_Observable, rxjs_Subject, url, rxjs_operator_filter, rxjs_operator_first, rxjs_operator_toPromise) {
    'use strict';
    ...
    var SERVER_HTTP_PROVIDERS = [
        {
            ...
            deps: [_angular_http.XHRBackend, _angular_http.RequestOptions]
        },
    ...
    ServerPlatformLocation.ctorParameters = function () {
        return [
            ...
            {
                type: undefined,
                decorators: [{type: _angular_core.Optional}, {type: _angular_core.Inject, args: [INITIAL_CONFIG,]},]
            },
        ];
    };
...
// TODO: build a proper list, this one is all the keys of a HTMLInputElement
    ...
    var DefaultServerRenderer2 = (function () {
        ...
        DefaultServerRenderer2.prototype.listen = function (target, eventName, callback) {
            ...
            var /** @type {?} */ outsideHandler = function (event) {
        ...
        return [
            {type: undefined, decorators: [{type: _angular_core.Inject, args: [_angular_platformBrowser.DOCUMENT,]},]},
            {
                ...
                decorators: [{type: _angular_core.Optional}, {
                    ...
                    args: [_angular_platformBrowser.ɵTRANSITION_ID,]
                },]
            },
        ];
    };
    ...
    function _render(platform, moduleRefPromise) {
        return moduleRefPromise.then(function (moduleRef) {
            ...
            return rxjs_operator_toPromise.toPromise
                .call(rxjs_operator_first.first.call(rxjs_operator_filter.filter.call(applicationRef.isStable, function (isStable) {
                    return isStable;
                })))
                .then(function () {
