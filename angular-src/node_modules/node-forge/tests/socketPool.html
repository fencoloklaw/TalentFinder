...
<div class="content">
    ...
    <fieldset class="section">
        <ul>
            ...
            <li>Note that the selected server must serve a Flash cross-domain policy file on the selected policy port.
            </li>
    ...
    <fieldset class="section">
        ...
        <div id="controls">
            <table>
                ...
                <tr>
                    <td>
                        <button id="init" disabled="disabled" class="sp-control sp-ready"
                                onclick="javascript:return sp_init();">init
                        </button>
                    </td>
                ...
                <tr>
                    <td>
                        <button id="cleanup" disabled="disabled" class="sp-control sp-initialized"
                                onclick="javascript:return sp_cleanup();">cleanup
                        </button>
                    </td>
                ...
                <tr>
                    <td>
                        <button id="create" disabled="disabled" class="sp-control sp-initialized"
                                onclick="javascript:return sp_create();">create socket
                        </button>
                    </td>
                ...
                <tr>
                    <td>
                        <button id="destroy" disabled="disabled" class="sp-control sp-created"
                                onclick="javascript:return sp_destroy();">destroy socket
                        </button>
                    </td>
                ...
                <tr>
                    <td>
                        <button id="connect" disabled="disabled" class="sp-control sp-created"
                                onclick="javascript:return sp_connect();">connect
                        </button>
                    </td>
                ...
                <tr>
                    <td>
                        <button id="isConnected" disabled="disabled" class="sp-control sp-created"
                                onclick="javascript:return sp_isConnected();">is connected
                        </button>
                    </td>
                ...
                <tr>
                    <td>
                        <button id="send" disabled="disabled" class="sp-control sp-connected"
                                onclick="javascript:return sp_send();">send
                        </button>
                    </td>
                ...
                <tr>
                    <td>
                        <button id="close" disabled="disabled" class="sp-control sp-connected"
                                onclick="javascript:return sp_close();">close
                        </button>
                    </td>
