...
<div class="content">
    ...
    <fieldset class="section">
        <ul>
            ...
            <li>This test connects to a TLS server so you must have one running. The easiest way to run this test is to
                start the test server with --tls and load this page over HTTPS.
            </li>
        </ul>
    </fieldset>
    ...
    <fieldset class="section">
        ...
        <div id="controls">
            ...
            <button id="websocket-webid" onclick="javascript:return websocket_webid('localhost', 8080);">websocket webid
                test
            </button>
        </div>
    </fieldset>
