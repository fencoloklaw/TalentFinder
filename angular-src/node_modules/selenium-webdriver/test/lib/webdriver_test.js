...
describe('WebDriver', function () {
    ...
    describe('testAttachToSession', function () {
        it('sessionIsAvailable', function () {
            ...
            let executor = new FakeExecutor().expect(CName.DESCRIBE_SESSION).withParameters({'sessionId': SESSION_ID}).andReturnSuccess(aSession).end();
        ...
        it('failsToGetSessionInfo', function () {
            ...
            let executor = new FakeExecutor().expect(CName.DESCRIBE_SESSION).withParameters({'sessionId': SESSION_ID}).andReturnError(e).end();
        ...
        it('usesActiveFlowByDefault', function () {
            let executor = new FakeExecutor().expect(CName.DESCRIBE_SESSION).withParameters({'sessionId': SESSION_ID}).andReturnSuccess({}).end();
    ...
    describe('testCreateSession', function () {
        it('happyPathWithCapabilitiesHashObject', function () {
            let aSession = new Session(SESSION_ID, {'browserName': 'firefox'});
            let executor = new FakeExecutor().expect(CName.NEW_SESSION).withParameters({
                'desiredCapabilities': {'browserName': 'firefox'}
            }).andReturnSuccess(aSession).end();
        ...
        it('happyPathWithCapabilitiesInstance', function () {
            let aSession = new Session(SESSION_ID, {'browserName': 'firefox'});
            let executor = new FakeExecutor().expect(CName.NEW_SESSION).withParameters({'desiredCapabilities': {'browserName': 'firefox'}}).andReturnSuccess(aSession).end();
        ...
        it('failsToCreateSession', function () {
            let executor = new FakeExecutor().expect(CName.NEW_SESSION).withParameters({'desiredCapabilities': {'browserName': 'firefox'}}).andReturnError(new StubError()).end();
        ...
        it('usesActiveFlowByDefault', function () {
            let executor = new FakeExecutor().expect(CName.NEW_SESSION).withParameters({'desiredCapabilities': {}}).andReturnSuccess(new Session(SESSION_ID)).end();
        ...
        it('canCreateInCustomFlow', function () {
            let executor = new FakeExecutor().expect(CName.NEW_SESSION).withParameters({'desiredCapabilities': {}}).andReturnSuccess({}).end();
    ...
    it('testStopsCommandExecutionWhenAnErrorOccurs', function () {
        ...
        let executor = new FakeExecutor().expect(CName.SWITCH_TO_WINDOW).withParameters({'name': 'foo'}).andReturnError(e).end();
    ...
    it('testCanSuppressCommandFailures', function () {
        let e = new error.NoSuchWindowError('window not found');
        let executor = new FakeExecutor().expect(CName.SWITCH_TO_WINDOW).withParameters({'name': 'foo'}).andReturnError(e).expect(CName.GET_TITLE).andReturnSuccess('Google Search').end();
    ...
    it('testErrbacksThatReturnErrorsStillSwitchToCallbackChain', function () {
        let executor = new FakeExecutor().expect(CName.SWITCH_TO_WINDOW).withParameters({'name': 'foo'}).andReturnError(new error.NoSuchWindowError('window not found')).end();

        var driver = executor.createDriver();
        return driver.switchTo().window('foo').catch(function () {
    ...
    it('testErrbacksThrownCanOverrideOriginalError', function () {
        let executor = new FakeExecutor().expect(CName.SWITCH_TO_WINDOW, {'name': 'foo'}).andReturnError(new error.NoSuchWindowError('window not found')).end();
    ...
    it('testReportsErrorWhenExecutingCommandsAfterExecutingAQuit', function () {
        ...
        return waitForAbort().then(expectedError(
    ...
    it('testCallbackCommandsExecuteBeforeNextCommand', function () {
        let executor = new FakeExecutor().expect(CName.GET_CURRENT_URL).expect(CName.GET, {'url': 'http://www.google.com'}).expect(CName.CLOSE).expect(CName.GET_TITLE).end();
    ...
    it('testEachCallbackFrameRunsToCompletionBeforeTheNext', function () {
        let executor = new FakeExecutor().expect(CName.GET_TITLE).expect(CName.GET_CURRENT_URL).expect(CName.GET_CURRENT_WINDOW_HANDLE).expect(CName.CLOSE).expect(CName.QUIT).end();

        var driver = executor.createDriver();
        driver.getTitle().// Everything in this callback...
        then(function () {
    ...
    describe('nestedCommandFailures', function () {
        it('bubbleUpToGlobalHandlerIfUnsuppressed', function () {
            let e = new error.NoSuchWindowError('window not found');
            let executor = new FakeExecutor().expect(CName.GET_TITLE).expect(CName.SWITCH_TO_WINDOW, {'name': 'foo'}).andReturnError(e).end();
        ...
        it('canBeSuppressWhenTheyOccur', function () {
            let executor = new FakeExecutor().expect(CName.GET_TITLE).expect(CName.SWITCH_TO_WINDOW, {'name': 'foo'}).andReturnError(new error.NoSuchWindowError('window not found')).expect(CName.CLOSE).end();
        ...
        it('canBeCaughtAndSuppressed', function () {
            let executor = new FakeExecutor().expect(CName.GET_TITLE).expect(CName.GET_CURRENT_URL).expect(CName.SWITCH_TO_WINDOW, {'name': 'foo'}).andReturnError(new StubError()).expect(CName.CLOSE).end();
    ...
    describe('returningAPromise', function () {
        it('fromACallback', function () {
            let executor = new FakeExecutor().expect(CName.GET_TITLE).expect(CName.GET_CURRENT_URL).andReturnSuccess('http://www.google.com').end();
        ...
        it('fromAnErrbackSuppressesTheError', function () {
            var count = 0;
            let executor = new FakeExecutor().expect(CName.SWITCH_TO_WINDOW, {'name': 'foo'}).andReturnError(new StubError()).expect(CName.GET_CURRENT_URL).andReturnSuccess('http://www.google.com').end();

            var driver = executor.createDriver();
            driver.switchTo().window('foo').catch(function (e) {
                assertIsStubError(e);
                count += 1;
                return driver.getCurrentUrl();
            }).then(function (url) {
    ...
    describe('customFunctions', function () {
        ...
        it('executionOrderWithCustomFunctions', function () {
            var msg = [];
            let executor = new FakeExecutor().expect(CName.GET_TITLE).andReturnSuccess('cheese ').expect(CName.GET_CURRENT_URL).andReturnSuccess('tasty').end();
        ...
        it('customFunctionSchedulesCommands', function () {
            let executor = new FakeExecutor().expect(CName.GET_TITLE).expect(CName.CLOSE).expect(CName.QUIT).end();
        ...
        it('returnsATaskResultAfterSchedulingAnother', function () {
            let executor = new FakeExecutor().expect(CName.GET_TITLE).andReturnSuccess('Google Search').expect(CName.CLOSE).end();
        ...
        it('hasANestedCommandThatFails', function () {
            let executor = new FakeExecutor().expect(CName.SWITCH_TO_WINDOW, {'name': 'foo'}).andReturnError(new StubError()).end();
        ...
        it('returnsADeferredAction', function () {
            let executor = new FakeExecutor().expect(CName.GET_TITLE).andReturnSuccess('Google').end();
    ...
    describe('nestedCommands', function () {
        ...
        it('normalCommandAfterNestedCommandThatReturnsAnAction', function () {
            var msg = [];
            let executor = new FakeExecutor().expect(CName.CLOSE).end();
            var driver = executor.createDriver();
            driver.call(function () {
                return driver.call(function () {
                    msg.push('a');
        ...
        it('canScheduleCommands', function () {
            let executor = new FakeExecutor().expect(CName.GET_TITLE).expect(CName.CLOSE).end();
    ...
    describe('executeScript', function () {
        it('nullReturnValue', function () {
            let executor = new FakeExecutor().expect(CName.EXECUTE_SCRIPT).withParameters({
                'script': 'return document.body;',
                'args': []
            }).andReturnSuccess(null).end();
        ...
        it('webElementPromiseArgumentConversion', function () {
            ...
            let executor = new FakeExecutor().expect(CName.FIND_ELEMENT,
                {
                    'using': 'css selector',
                    'value': '*[id="foo"]'
                }).andReturnSuccess(elementJson).expect(CName.EXECUTE_SCRIPT).withParameters({
                'script': 'return 1;',
                'args': [elementJson]
            }).andReturnSuccess(null).end();
        ...
        it('scriptReturnsAnError', function () {
            let executor = new FakeExecutor().expect(CName.EXECUTE_SCRIPT).withParameters({
                ...
                'args': ['bam']
            }).andReturnError(new StubError).end();
            var driver = executor.createDriver();
        ...
        it('failsIfArgumentIsARejectedPromise', function () {
            ...
            var driver = executor.createDriver();
            return driver.executeScript(function () {
            }, arg).then(fail, assertIsStubError);
        });
    });
    ...
    describe('findElement', function () {
        it('elementNotFound', function () {
            let executor = new FakeExecutor().expect(CName.FIND_ELEMENT,
                {using: 'css selector', value: '*[id="foo"]'}).andReturnError(new StubError).end();
            ...
            let executor = new FakeExecutor().expect(CName.FIND_ELEMENT,
                {
                    using: 'css selector',
                    value: '*[id="foo"]'
                }).andReturnSuccess(WebElement.buildId('bar')).expect(CName.CLICK_ELEMENT, {'id': 'bar'}).andReturnSuccess().end();
        ...
        it('byJs', function () {
            let executor = new FakeExecutor().expect(CName.EXECUTE_SCRIPT, {
                'script': 'return document.body',
                'args': []
            }).andReturnSuccess(WebElement.buildId('bar')).expect(CName.CLICK_ELEMENT, {'id': 'bar'}).end();
        ...
        it('byJs_canPassArguments', function () {
            ...
            let executor = new FakeExecutor().expect(CName.EXECUTE_SCRIPT, {
                'script': script,
                'args': ['div']
            }).andReturnSuccess({'ELEMENT': 'one'}).end();
            var driver = executor.createDriver();
        ...
        it('customLocator', function () {
            let executor = new FakeExecutor().expect(CName.FIND_ELEMENTS, {
                'using': 'css selector',
                'value': 'a'
            }).andReturnSuccess([
                WebElement.buildId('foo'),
                WebElement.buildId('bar')]).expect(CName.CLICK_ELEMENT, {'id': 'foo'}).andReturnSuccess().end();
    ...
    describe('isElementPresent', function () {
        it('elementNotFound', function () {
            let executor = new FakeExecutor().expect(CName.FIND_ELEMENTS,
                {using: 'css selector', value: '*[id="foo"]'}).andReturnSuccess([]).end();
        ...
        it('elementFound', function () {
            let executor = new FakeExecutor().expect(CName.FIND_ELEMENTS,
                {using: 'css selector', value: '*[id="foo"]'}).andReturnSuccess([WebElement.buildId('bar')]).end();
        ...
        it('byJs', function () {
            let executor = new FakeExecutor().expect(CName.EXECUTE_SCRIPT, {
                'script': 'return 123',
                'args': []
            }).andReturnSuccess([WebElement.buildId('bar')]).end();
        ...
        it('byJs_canPassScriptArguments', function () {
            ...
            let executor = new FakeExecutor().expect(CName.EXECUTE_SCRIPT, {
                'script': script,
                'args': ['div']
            }).andReturnSuccess([WebElement.buildId('one')]).end();
    ...
    describe('findElements', function () {
        it('returnsMultipleElements', function () {
            ...
            let executor = new FakeExecutor().expect(CName.FIND_ELEMENTS, {
                'using': 'css selector',
                'value': 'a'
            }).andReturnSuccess(ids.map(WebElement.buildId)).end();
        ...
        it('byJs', function () {
            ...
            return driver.findElements(By.js('return document.getElementsByTagName("div");')).then(function (elements) {
                return promise.all(elements.map(function (e) {
                    assert.ok(e instanceof WebElement);
                    return e.getId();
                }));
        ...
        it('byJs_filtersOutNonWebElementResponses', function () {
            ...
            var driver = executor.createDriver();
            driver.findElements(By.js('return document.getElementsByTagName("div");')).then(function (elements) {
                return promise.all(elements.map(function (e) {
                    assert.ok(e instanceof WebElement);
                    return e.getId();
                }));
        ...
        it('byJs_convertsSingleWebElementResponseToArray', function () {
            let executor = new FakeExecutor().expect(CName.EXECUTE_SCRIPT, {
                'script': 'return document.getElementsByTagName("div");',
                'args': []
            }).andReturnSuccess(WebElement.buildId('foo')).end();
    ...
    describe('sendKeys', function () {
        it('convertsVarArgsIntoStrings_simpleArgs', function () {
            let executor = new FakeExecutor().expect(CName.SEND_KEYS_TO_ELEMENT,
                {'id': 'one', 'value': '12abc3'.split('')}).andReturnSuccess().end();
            ...
            let executor = new FakeExecutor().expect(CName.FIND_ELEMENT,
                {
                    'using': 'css selector',
                    'value': '*[id="foo"]'
                }).andReturnSuccess(WebElement.buildId('one')).expect(CName.SEND_KEYS_TO_ELEMENT,
                {'id': 'one', 'value': 'abc123def'.split('')}).andReturnSuccess().end();
    ...
    describe('waiting', function () {
        it('waitSucceeds', function () {
            let executor = new FakeExecutor().expect(CName.FIND_ELEMENTS,
                {using: 'css selector', value: '*[id="foo"]'}).andReturnSuccess([]).times(2).expect(CName.FIND_ELEMENTS,
                {using: 'css selector', value: '*[id="foo"]'}).andReturnSuccess([WebElement.buildId('bar')]).end();
        ...
        it('waitTimesout_timeoutCaught', function () {
            let executor = new FakeExecutor().expect(CName.FIND_ELEMENTS,
                {using: 'css selector', value: '*[id="foo"]'}).andReturnSuccess([]).anyTimes().end();
    ...
    it('testFetchingLogs', function () {
        let executor = new FakeExecutor().expect(CName.GET_LOG, {'type': 'browser'}).andReturnSuccess([
    ...
    it('testWebElementCommansFailIfElementCouldNotBeFound', function () {
        ...
        let executor = new FakeExecutor().expect(CName.FIND_ELEMENT,
            {using: 'css selector', value: '*[id="foo"]'}).andReturnError(e).end();
    ...
    describe('actions()', function () {
        it('failsIfInitialDriverCreationFailed', function () {
            ...
            return new FakeExecutor().createDriver(session).actions().mouseDown().mouseUp().perform().catch(assertIsStubError);
        });
        ...
        describe('mouseMove', function () {
            it('noElement', function () {
                ...
                return executor.createDriver().actions().mouseMove({x: 0, y: 125}).perform();
            });
        ...
        it('supportsMouseDown', function () {
            ...
            return executor.createDriver().actions().mouseDown().perform();
        });
    ...
    describe('touchActions()', function () {
        it('failsIfInitialDriverCreationFailed', function () {
            ...
            return new FakeExecutor().createDriver(session).touchActions().scroll({
                x: 3,
                y: 4
    ...
    describe('wire format', function () {
        describe('can serialize', function () {
            function runSerializeTest(input, want) {
                let executor = new FakeExecutor().expect(CName.NEW_SESSION).withParameters({'desiredCapabilities': want}).andReturnSuccess({'browserName': 'firefox'}).end();
