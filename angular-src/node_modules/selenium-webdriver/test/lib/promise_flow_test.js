...
describe('promise control flow', function () {
    ...
    describe('testErrorHandling', function () {
        it('thrownErrorsArePassedToTaskErrback', function () {
            scheduleAction('function that throws', throwStubError).then(fail, assertIsStubError);
            return waitForIdle();
        });

        it('thrownErrorsPropagateThroughPromiseChain', function () {
            scheduleAction('function that throws', throwStubError).then(fail).then(fail, assertIsStubError);
            return waitForIdle();
        });
        ...
        it('abortsIfThereIsAnUnhandledRejection', function () {
            ...
            return waitForAbort().then(assertIsStubError).then(function () {
        ...
        it('abortsWhenErrorBubblesUpFromFullyResolvingAnObject', function () {
            ...
            return waitForAbort().then(assertIsStubError).then(() => assert(!callback.called));
        });
        ...
        it('abortsWhenErrorBubblesUpFromFullyResolvingAnObject_withCallback', function () {
            ...
            return waitForAbort().then(assertIsStubError).then(() => assert(!callback1.called)).then(() => assert(!callback2.called));
        });
    ...
    describe('testTryModelingFinally', function () {
        it('happyPath', function () {
             ...
             */
            schedulePush('foo').then(() => schedulePush('bar')).thenFinally(() => schedulePush('baz'));
        ...
        it('firstTryFails', function () {
            ...
            return waitForAbort().then(assertIsStubError).then(assertingMessages('foo', 'baz'));
        });
        ...
        it('secondTryFails', function () {
            ...
            schedulePush('foo').then(function () {
            ...
            return waitForAbort().then(assertIsStubError).then(assertingMessages('foo', 'bar', 'baz'));
        });
    });
    ...
    describe('testWaiting', function () {
        ...
        it('failsIfConditionThrows', function () {
            ...
            scheduleWait(throwStubError, 0, 'goes boom').then(callbacks.callback, callbacks.errback);
            schedule('post wait');

            return waitForIdle().then(callbacks.assertErrback).then(function () {
    ...
    describe('testEventLoopWaitsOnPendingPromiseRejections', function () {
        it('oneRejection', function () {
            ...
            return timeout(50).then(function () {
                ...
                return waitForAbort();
            }).then(assertIsStubError).then(function () {
                assertFlowHistory('one');
            });
        });
    ...
    it('testMaintainsOrderInCallbacksWhenATaskReturnsAPromise', function () {
        schedule('__start__', promise.fulfilled()).then(function () {
            messages.push('a');
            schedulePush('b');
            messages.push('c');
        }).then(function () {
    ...
    it('testCanSynchronizeFlowsByReturningPromiseFromOneToAnother', function () {
        ...
        return NativePromise.all([flow1Done.promise, flow2Done.promise]).then(function () {
