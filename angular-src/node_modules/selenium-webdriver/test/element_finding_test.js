    ...
    describe('finding elements', function () {
        ...
        describe('By.id()', function () {
            ...
            test.it('should fail if ID not present on page', function () {
                driver.get(Pages.formPage);
                driver.findElement(By.id('nonExistantButton')).then(fail, function (e) {
        ...
        describe('By.linkText()', function () {
            ...
            test.it('should work when link text contains equals sign', function () {
                driver.get(Pages.xhtmlTestPage);
                var id = driver.findElement(By.linkText('Link=equalssign')).getAttribute('id');
            ...
            test.it('matches by partial text when containing equals sign',
                function () {
                    driver.get(Pages.xhtmlTestPage);
                    var id = driver.findElement(By.partialLinkText('Link=')).getAttribute('id');
                    assert(id).equalTo('linkWithEqualsSign');
                });
            ...
            test.it('works when searching for multiple and text contains =',
                function () {
                    driver.get(Pages.xhtmlTestPage);
                    driver.findElements(By.linkText('Link=equalssign')).then(function (elements) {
            ...
            test.it(
                ...
                function () {
                    driver.get(Pages.xhtmlTestPage);
                    driver.findElements(By.partialLinkText('Link=')).then(function (elements) {
                        assert(elements.length).equalTo(1);
                        return elements[0].getAttribute('id');
                    }).then(function (id) {
                        assert(id).equalTo('linkWithEqualsSign');
            ...
            test.it('should be able to find multiple partial matches',
                function () {
                    driver.get(Pages.xhtmlTestPage);
                    driver.findElements(By.partialLinkText('ick me')).then(function (elements) {
                        assert(elements.length).equalTo(2);
                    });
                });
        ...
        describe('By.className()', function () {
            ...
            test.it('should fail if queried name only partially matches', function () {
                driver.get(Pages.xhtmlTestPage);
                driver.findElement(By.className('nameB')).then(fail, function (e) {
                    assert(e).instanceOf(error.NoSuchElementError);
                });
            });
        ...
        describe('By.css()', function () {
            ...
            test.it('should be able to find multiple elements by compound selector',
                function () {
                    driver.get(Pages.xhtmlTestPage);
                    driver.findElements(By.css('div.extraDiv, div.content')).then(function (elements) {
            ...
            test.ignore(browsers(Browser.IE)).it('should be able to find element by boolean attribute', function () {
