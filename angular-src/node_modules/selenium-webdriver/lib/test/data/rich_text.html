...
<div>
    ...
    <table width="100%">
        <tr valign="top">
            <td width="50%">
                <div>IFRAME</div>
                <iframe id="editFrame" name="editFrame" src="" height="200px" width="300px" frameborder="0"
                        style="border: 1px solid black;">
                </iframe>
                <div id="editFrameInfo">
                    <pre>frame.contentWindow.document.designMode: on<br>frame.contentWindow.document.body.contentEditable: false<br></pre>
                </div>
            </td>
            <td>
                <div>DIV</div>
                ...
                <div id="editDivInfo">
                    <pre>div.ownerDocument.designMode: off<br>div.ownerDocument.body.contentEditable: false<br>div.contentEditable: true<br></pre>
                </div>
            </td>
        </tr>
    </table>
