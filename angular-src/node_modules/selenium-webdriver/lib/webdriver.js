...
class Timeouts {
    ...
    implicitlyWait(ms) {
        return this.driver_.schedule(
            new command.Command(command.Name.IMPLICITLY_WAIT).setParameter('ms', ms < 0 ? 0 : ms),
    ...
    setScriptTimeout(ms) {
        return this.driver_.schedule(
            new command.Command(command.Name.SET_SCRIPT_TIMEOUT).setParameter('ms', ms < 0 ? 0 : ms),
    ...
    pageLoadTimeout(ms) {
        return this.driver_.schedule(
            new command.Command(command.Name.SET_TIMEOUT).setParameter('type', 'page load').setParameter('ms', ms),
...
class Window {
    ...
    getPosition() {
        return this.driver_.schedule(
            new command.Command(command.Name.GET_WINDOW_POSITION).setParameter('windowHandle', 'current'),
    ...
    setPosition(x, y) {
        return this.driver_.schedule(
            new command.Command(command.Name.SET_WINDOW_POSITION).setParameter('windowHandle', 'current').setParameter('x', x).setParameter('y', y),
    ...
    getSize() {
        return this.driver_.schedule(
            new command.Command(command.Name.GET_WINDOW_SIZE).setParameter('windowHandle', 'current'),
    ...
    setSize(width, height) {
        return this.driver_.schedule(
            new command.Command(command.Name.SET_WINDOW_SIZE).setParameter('windowHandle', 'current').setParameter('width', width).setParameter('height', height),
...
class Logs {
    ...
    get(type) {
        ...
        return this.driver_.schedule(
            cmd, 'WebDriver.manage().logs().get(' + type + ')').then(function (entries) {
...
class TargetLocator {
    ...
    window(nameOrHandle) {
        return this.driver_.schedule(
            new command.Command(command.Name.SWITCH_TO_WINDOW).setParameter('name', nameOrHandle),
   ...
   *     }
    ...
    findElement(locator) {
        ...
        if (typeof locator === 'function') {
            ...
            let cmd = new command.Command(
                command.Name.FIND_CHILD_ELEMENT).setParameter('using', locator.using).setParameter('value', locator.value);
    ...
    findElements(locator) {
        ...
        if (typeof locator === 'function') {
            ...
            var cmd = new command.Command(
                command.Name.FIND_CHILD_ELEMENTS).setParameter('using', locator.using).setParameter('value', locator.value);
    ...
    sendKeys(var_args) {
        ...
        if (!this.driver_.fileDetector_) {
            return this.schedule_(
                new command.Command(command.Name.SEND_KEYS_TO_ELEMENT).setParameter('value', keys),
                'WebElement.sendKeys()');
        }
