...
goog.string.compareVersions = function (a, b) {
    for (var c = 0, d = goog.string.trim(String(a)).split("."), e = goog.string.trim(String(b)).split("."), f = Math.max(d.length, e.length), g = 0; 0 == c && g < f; g++) {
        ...
        do {
            ...
            var c = 0 == m[1].length ? 0 : parseInt(m[1], 10), q = 0 == n[1].length ? 0 : parseInt(n[1], 10),
...
goog.debug.DivConsole.prototype.addLogRecord = function (a) {
    if (a) {
        var b = 100 >= this.element_.scrollHeight - this.element_.scrollTop - this.element_.clientHeight,
            c = this.elementOwnerDocument_.createElement(goog.dom.TagName.DIV);
        c.className = "logmsg";
...
bot.userAgent.FIREFOX_EXTENSION = function () {
    ...
    var b = a.classes, a = a.interfaces,
        ...
        b = b["@mozilla.org/xre/app-info;1"].getService(a.nsIXULAppInfo), d = b.platformVersion, e = b.version;
