...
var NoUnusedVariablesWalker = (function (_super) {
    ...
    NoUnusedVariablesWalker.prototype.visitSourceFile = function (node) {
        ...
        if (this.possibleFailures.some(function (f) {
                return f.fix !== undefined;
            })) {
            var newText = Lint.Fix.applyAll(this.getSourceFile().getFullText(), this.possibleFailures.map(function (f) {
                return f.fix;
            }).filter(function (f) {
                return f !== undefined;
            }));
    ...
    NoUnusedVariablesWalker.prototype.visitImportDeclaration = function (node) {
        ...
        if (importClause.namedBindings != null) {
            if (importClause.namedBindings.kind === ts.SyntaxKind.NamedImports && node.importClause !== undefined) {
                ...
                usedNamedImports = imports.elements.map(function (e) {
                    return _this.isUsed(e.name.text, e.name.getStart());
                });
            }
        ...
        if (!usesDefaultImport && usedNamedImports.every(function (e) {
                return !e;
            })) {
        ...
        if (importClause.namedBindings != null &&
            ...
            if (usedNamedImports.every(function (e) {
                    return !e;
                })) {
    ...
    NoUnusedVariablesWalker.prototype.fail = function (type, name, position, replacements) {
        ...
        this.possibleFailures.push({
            start: position,
            width: name.length,
            message: Rule.FAILURE_STRING_FACTORY(type, name),
            fix: fix
        });
    };
