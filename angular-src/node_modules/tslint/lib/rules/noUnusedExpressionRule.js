...
var NoUnusedExpressionWalker = (function (_super) {
    ...
    NoUnusedExpressionWalker.isDirective = function (node, checkPreviousSiblings) {
        if (checkPreviousSiblings === void 0) {
            checkPreviousSiblings = true;
        }
        ...
        if (checkPreviousSiblings) {
            ...
            ts.forEachChild(parent, function (child) {
                siblings_1.push(child);
            });
            return siblings_1.slice(0, siblings_1.indexOf(node)).every(function (n) {
                return NoUnusedExpressionWalker.isDirective(n, false);
            });
        }
        else {
            return true;
