...
/* TS v1.8 => "notScheduled", "scheduling", "scheduled", "running", "canceling" */
...
const Zone: ZoneType = (function (global: any) {
    ...
    class Zone implements AmbientZone {
        ...
        public runGuarded<T>(callback: (...args: any[]) => T, applyThis: any = null, applyArgs: any[] = null,
                             source: string = null) {
            _currentZoneFrame = new ZoneFrame(_currentZoneFrame, this);
            try {
                try {
    ...
    class ZoneTask implements Task {
        ...
        constructor(type: TaskType, source: string, callback: Function, options: TaskData,
    ...
    function scheduleResolveOrReject<R, U>(promise: ZoneAwarePromise<any>, zone: AmbientZone, chainPromise: ZoneAwarePromise<any>,
    ...
    class ZoneAwarePromise<R> implements Promise<R> {
        ...
        constructor(executor: (resolve: (value?: R | PromiseLike<R>) => void, reject: (error?: any) => void) => void) {
    ...
    let detectZone: Zone = Zone.current.fork({
        name: 'detect',
        onInvoke: function (parentZoneDelegate: ZoneDelegate, currentZone: Zone, targetZone: Zone, delegate: Function,
                            applyThis: any, applyArgs: any[], source: string): any {
