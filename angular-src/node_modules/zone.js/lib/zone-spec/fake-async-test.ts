...
(function (global: any) {
    ...
    class Scheduler {
        ...
        scheduleFunction(cb: Function, delay: number, args: any[] = [], id: number = -1): number {
            ...
            let newEntry: ScheduledFunction = {endTime: endTime, id: currentId, func: cb, args: args, delay: delay};
            let i = 0;
    ...
    class FakeAsyncTestZoneSpec implements ZoneSpec {
        ...
        private _fnAndFlush(fn: Function, completers: { onSuccess?: Function, onError?: Function }): Function {
            return (...args): boolean => {
