    ...
    (function n(v, m, c) {
        ...
        4: [function (n, v, m) {
            function c(g, l, b) {
                ...
                if (c._useTypedArrays && "number" === typeof g.byteLength) f._set(g); else {
                    var e = g;
                    if (L(e) || c.isBuffer(e) || e && "object" === typeof e && "number" ===
                        typeof e.length) for (l = 0; l < a; l++) c.isBuffer(g) ? f[l] = g.readUInt8(l) : f[l] = g[l]; else if ("string" === x) f.write(g, 0, l); else if ("number" === x && !c._useTypedArrays && !b) for (l = 0; l < a; l++) f[l] = 0
                }
                return f
            }
        ...
        12: [function (n, v, m) {
            ...
            c.prototype.add = function (c) {
                var k = this._last, e = k.generatedLine, a = c.generatedLine, h = k.generatedColumn,
                    u = c.generatedColumn;
                a > e || a == e && u >= h || 0 >= d.compareByGeneratedPositionsInflated(k, c) ? this._last = c : this._sorted = !1;
                this._array.push(c)
            };
            c.prototype.toArray = function () {
                this._sorted || (this._array.sort(d.compareByGeneratedPositionsInflated), this._sorted =
                    !0);
                return this._array
            };
            m.MappingList = c
        ...
        14: [function (n, v, m) {
            ...
            function d(b) {
                ...
                var c = e.getArg(a, "sources"), t = e.getArg(a, "names", []), d = e.getArg(a, "sourceRoot", null),
                    r = e.getArg(a, "sourcesContent", null), k = e.getArg(a, "mappings"), a = e.getArg(a, "file", null);
            ...
            var e = n("./util"), a = n("./binary-search"), h = n("./array-set").ArraySet, u = n("./base64-vlq"),
            ...
            c.prototype.allGeneratedPositionsFor = function (b) {
                var c = e.getArg(b, "line"),
                    d = {source: e.getArg(b, "source"), originalLine: c, originalColumn: e.getArg(b, "column", 0)};
            ...
            d.fromSourceMap = function (b) {
                var a = Object.create(d.prototype), c = a._names = h.fromArray(b._names.toArray(), !0),
        ...
        15: [function (n, v, m) {
            ...
            var d = n("./base64-vlq"), k = n("./util"), q = n("./array-set").ArraySet,
        ...
        19: [function (n, v, m) {
            (function (c, d) {
                ...
                var L = !1, C = !1, y = !1, K = "auto", A = {}, F = {}, H = /^data:application\/json[^,]+base64,/,
                    z = [], E =
                        [], p = q(z);
                z.push(function (a) {
                    a = a.trim();
