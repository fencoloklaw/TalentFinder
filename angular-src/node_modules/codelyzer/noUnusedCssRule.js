...
var lang = require('cssauron')({
    ...
    'class': function (node) {
        var classBindings = (node.inputs || [])
            .filter(function (b) {
                return b.type === compiler_1.PropertyBindingType.Class;
            })
            .map(function (b) {
                return b.name;
            }).join(' ');
        var classAttr = node.attrs.filter(function (a) {
    ...
    attr: function (node, attr) {
        var targetAttr = node.attrs.filter(function (a) {
            return a.name === attr;
        }).pop();
        if (targetAttr) {
...
var hasSelector = function (s, type) {
    ...
    if (s.type === 'selector' || s.type === 'selectors') {
        return (s.nodes || []).some(function (n) {
...
var dynamicFilters = {
    ...
    attribute: function (ast, selector) {
        return (ast.inputs || []).some(function (i) {
            return i.type === compiler_1.PropertyBindingType.Attribute;
        });
    },
