    ...
    return function (validateFn) {
        return ({
            ...
            validate: function (node, options) {
                return (node.kind === syntaxKind) ? validateFn(node, options) : function_1.Maybe.nothing;
            },
        });
    };
}
    ...
    return function (sourceFile, options) {
        var e = (function (_super) {
            ...
            class_1.prototype.visitNg2Component = function (meta) {
                ...
                validators.forEach(function (v) {
                    if (v.kind === 'Ng2Component') {
                        v.validate(meta, _this.getOptions()).fmap(function (failures) {
                            return failures.forEach(function (f) {
                                return _this.failed(f);
                            });
                        });
                    }
                });
            ...
            class_1.prototype.visitNode = function (node) {
                ...
                validators.forEach(function (v) {
                    if (v.kind === 'Node') {
                        v.validate(node, _this.getOptions()).fmap(function (failures) {
                            return failures.forEach(function (f) {
                                return _this.failed(f);
                            });
                        });
