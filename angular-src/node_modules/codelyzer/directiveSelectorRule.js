...
var Rule = (function (_super) {
    ...
    Rule.prototype.getTypeFailure = function () {
        return 'The selector of the directive "%s" should be used as %s (https://goo.gl/QS8kEs)';
    };
    Rule.prototype.getNameFailure = function () {
        return 'The selector of the directive "%s" should be named %s (https://goo.gl/QS8kEs)';
    };
    Rule.prototype.getSinglePrefixFailure = function () {
        return 'The selector of the directive "%s" should have prefix "%s" (https://goo.gl/uacjKR)';
    };
    Rule.prototype.getManyPrefixFailure = function () {
