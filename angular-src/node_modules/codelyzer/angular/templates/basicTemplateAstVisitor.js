...
var BasicTemplateAstVisitor = (function (_super) {
    ...
    function BasicTemplateAstVisitor(sourceFile, _originalOptions, context, templateStart, expressionVisitorCtrl) {
        if (expressionVisitorCtrl === void 0) {
    ...
    BasicTemplateAstVisitor.prototype.visitNg2TemplateAST = function (ast, templateStart) {
        ...
        templateVisitor.getFailures().forEach(function (f) {
    ...
    BasicTemplateAstVisitor.prototype.visitEmbeddedTemplate = function (ast, context) {
        var _this = this;
        ast.variables.forEach(function (v) {
            return _this.visit(v, context);
        });
        ast.children.forEach(function (e) {
            return _this.visit(e, context);
        });
        ast.outputs.forEach(function (o) {
            return _this.visit(o, context);
        });
        ast.attrs.forEach(function (a) {
            return _this.visit(a, context);
        });
        ast.references.forEach(function (r) {
            return _this.visit(r, context);
        });
        ast.directives.forEach(function (d) {
            return _this.visit(d, context);
        });
    };
    BasicTemplateAstVisitor.prototype.visitElement = function (element, context) {
        var _this = this;
        element.references.forEach(function (r) {
            return _this.visit(r, context);
        });
        element.inputs.forEach(function (i) {
            return _this.visit(i, context);
        });
        element.outputs.forEach(function (o) {
            return _this.visit(o, context);
        });
        ...
        element.directives.forEach(function (d) {
            return _this.visit(d, context);
        });
    };
    ...
    BasicTemplateAstVisitor.prototype.visitDirective = function (ast, context) {
        var _this = this;
        ast.inputs.forEach(function (o) {
            return _this.visit(o, context);
        });
        ast.hostProperties.forEach(function (p) {
            return _this.visit(p, context);
        });
        ast.hostEvents.forEach(function (e) {
            return _this.visit(e, context);
        });
    };
