    ...
    pp$3.parseSubscripts = function (base, startPos, startLoc, noCalls) {
        ...
        for (var computed = (void 0); ;) {
            if ((computed = this$1.eat(types.bracketL)) || this$1.eat(types.dot)) {
                ...
                var refDestructuringErrors = new DestructuringErrors, oldYieldPos = this$1.yieldPos,
    ...
    pp$3.parseParenAndDistinguishExpression = function (canBeArrow) {
        ...
        if (this.options.ecmaVersion >= 6) {
            ...
            var refDestructuringErrors = new DestructuringErrors, oldYieldPos = this.yieldPos,
                oldAwaitPos = this.awaitPos, spreadStart, innerParenStart;
            this.yieldPos = 0;
            this.awaitPos = 0;
...
// Parse an object literal or binding pattern.
    ...
    pp$3.parseObj = function (isPattern, refDestructuringErrors) {
        ...
        while (!this.eat(types.braceR)) {
            ...
            var prop = this$1.startNode(), isGenerator = (void 0), isAsync = (void 0), startPos = (void 0),
                startLoc = (void 0);
