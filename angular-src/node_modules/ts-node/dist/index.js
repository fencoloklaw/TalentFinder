...
function getDirectories(path) {
    return fs_1.readdirSync(path).filter(function (name) {
        return directoryExists(path_1.join(path, name));
    });
}
...
function formatDiagnostic(diagnostic, cwd, ts) {
    ...
    if (diagnostic.file) {
        ...
        var _a = diagnostic.file.getLineAndCharacterOfPosition(diagnostic.start), line = _a.line,
