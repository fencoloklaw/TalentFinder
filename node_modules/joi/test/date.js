            ...
            it('errors if reference is not a date', function (done) {
                ...
                Helper.validate(schema, [
                    [{
                        a: 'abc',
                        b: now
                    }, false, null, 'child "b" fails because ["b" references "a" which is not a date]'],
                    [{a: '123', b: now}, true],
                    [{
                        a: (now + 1e3).toString(),
                        b: now
                    }, false, null, /^child "b" fails because \["b" must be larger than or equal to/]
                ], done);
            });
            ...
            it('errors if reference is not a date', function (done) {
                ...
                Helper.validate(schema, [
                    ...
                    [{
                        a: (now - 1e3).toString(),
                        b: now
                    }, false, null, /^child "b" fails because \["b" must be less than or equal to/]
                ], done);
            });
